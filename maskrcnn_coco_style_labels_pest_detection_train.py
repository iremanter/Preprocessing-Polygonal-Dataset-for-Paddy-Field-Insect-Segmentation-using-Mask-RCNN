...
class CocoLikeDataset(utils.Dataset):
    def load_data(self, annotation_json, images_dir):
        ...
        # Add class names using the base method from utils.Dataset
        ...
        for image in coco_json['images']:
            ...
            if image_id in seen_images:
                ...
                # Ensure the image has corresponding annotations
                if image_id not in annotations:
                    print(f"Warning: Skipping image (id: {image_id}) as it has no corresponding annotations.")
                    continue
...
dataset_train.load_data('paddy_with_pests/train/labels/instances_default.json', 'paddy_with_pests/train')
dataset_train.prepare()

#In this example, I do not have annotations for my validation data, so I am loading train data
dataset_val = CocoLikeDataset()
dataset_val.load_data('paddy_with_pests/train/labels/instances_default.json', 'paddy_with_pests/val')
dataset_val.prepare()
...
# load model weights
model.load_weights('logs/mask_rcnn_pest_cfg_coco_0001.h5', by_name=True)
...
marbles_img = skimage.io.imread("paddy_with_pests/val/00000001.jpg")
...
detect_and_color_splash(model, image_path="paddy_with_pests/val/00000015.JPG")
